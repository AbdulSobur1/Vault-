  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted mt-1">Explore our loan offerings</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {loanTypes.map((loan) => {
          ...
          return (
            <div
              key={loan.title}
              className="rounded-lg border border-border bg-white dark:bg-dark-card dark:border-dark-border p-6 flex flex-col"
            >
              ...
              <p className="text-sm text-muted mb-4 flex-1">{loan.description}</p>
